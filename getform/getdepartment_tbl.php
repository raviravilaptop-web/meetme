            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered first" id = "tbldept">
                            <thead>
                                <tr>
                                    <th>Ministry ID</th>
                                    <th>Department ID</th>
                            ...
                            <tbody>
                                ...
                                $sqld = null;
                                 if ($uleveldis == '1269_mt') {
                                    $sqld = "SELECT `sno`, `dept_id`,`province_code`, `min_id`, `dept_name`, `address`, `hesd_of_dept`, `head_vote`, `contact` FROM `tbl_department`";
                                } else  if ($uleveldis == '1548_sa') {
                                    $sqld = "SELECT `sno`, `dept_id`,`province_code`, `min_id`, `dept_name`, `address`, `hesd_of_dept`, `head_vote`, `contact` FROM `tbl_department`WHERE `province_code` = '$province'AND  `min_id` =  '$ministry'";
                                } else if ($uleveldis == '1658_pa') {
                                    $sqld = "SELECT `sno`, `dept_id`,`province_code`, `min_id`, `dept_name`, `address`, `hesd_of_dept`, `head_vote`, `contact` FROM `tbl_department`WHERE `province_code` = '$province' AND  `min_id` =  '$ministry'AND  `dept_id` =  '$district_offce'";
                                } else if ($uleveldis == '2753_ps') {
                                    $sqld = "SELECT `sno`, `dept_id`,`province_code`, `min_id`, `dept_name`, `address`, `hesd_of_dept`, `head_vote`, `contact` FROM `tbl_department`WHERE `province_code` = 'null' ";
                                }
                                    ...
                                    if ($db->getresultset($sqld)) {
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td style = "text-align: left;"><?php echo $hesd_of_dept ?></td>
