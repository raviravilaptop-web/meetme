...
<div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select type="text" class="form-control Signup_Frm Signup_province_s" id="Signup_province_s"placeholder="Province" onclick="clk_proid()">
                                    ...
                                    <input hidden class="Signup_Frm Signup_province" id="Signup_province"name="Signup_province"></input>
                                </div>
