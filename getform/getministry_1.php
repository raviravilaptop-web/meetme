...
<div class="input-group input-search">
    <select type="text" class="form-control Signup_Frm pro_min_id" id="pro_min_id"name="pro_min_id"placeholder="Ministry" onclick="clk_minid()">
...
<input hidden id="inpuminid"name="inpuminid"></input>
